...
<div id="div1"><p class="tab">Gra bounce polega na odbijaniu piłeczki poruszającej się na ekranie. Sterowanie odbywa się
        za pomocą strzałek; strzałka w lewo - ruch w lewo, strzałka w prawo - ruch w prawo. W celu wystartowania gry
        należy nacisnąć spację. Występują trzy poziomy rozgrywki. Wraz z trudnością rozgrywki rośnie prędkość piłeczki i
        maleje pole służące do odbijania. W celu zagrania należy wybrać jeden z poniższych poziomów.</p>

    <p class="levelChoice" style="font-weight: bold">Wybierz poziom trudności</p>

    <a href="latwy\lekcja6.php">
        <button class="levelButton" style="left: 0%; background: #27ae60"><p class="levelText">łatwy</p></button>
    </a>
    <a href="sredni\lekcja6.php">
        <button class="levelButton" style="left: 37%; background: #ff9900"><p class="levelText">średni</p></button>
    </a>
    <a href="trudny\lekcja6.php">
